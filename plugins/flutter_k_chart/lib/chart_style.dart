...
class ChartColors {
  ...
  static const Color gridColor = Color(0xfff3f4f6);
  ...
  static const Color drawCrossLineColorY = Color.fromRGBO(0, 39, 37, 0.1);
  static const Color drawCrossLineColorX = Color(0xff15181d);
}
